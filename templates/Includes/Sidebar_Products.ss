				...
				<% if LinkOrSection = section %>
					...
					<ul class="sub">
						<li>
							<ul class="roundWhite">
								<% control ChildGroups %>
									<li><a href="$Link" title="<% sprintf(_t("ProductGroup.GOTOPAGE","Go to the %s page"),$Title.XML) %>" class="$LinkingMode levelb"><span><em>$MenuTitle.LimitCharacters(22)</em></span></a></li>
								<% end_control %>
							</ul>
						</li>
					</ul>
